...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create an instance to store game statistics and create score baord
    ...
    def _update_aliens(self):
        """check if the fleet is at an edge then update postion of all aliens """
    ...
    def _check_fleet_edges(self):
        """Responds appropriatly if any aliens have reached an edge """
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this the same as if the ship got hiy
                self._ship_hit()
                break
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # Get rid of remaing aliens and bullets
            self.aliens.empty()
            self.bullets.empty()
